...
function Dashboard(props) {
    ...
    let categorySelector = (e) => setFilteredPosts(posts.filter((ele) => ele.category === e))
    ...
    return (
        <div className='dashboard'>
            <div className='categories'>
                <div className='each-category'>
                    <a
                        onClick={(e) => categorySelector("hobbies")}
                        name='hobbies'>
                        <img
                            src={hobbies}
                            className='hobbies'
                    ...
                    <a
                        onClick={(e) => categorySelector("outdoors")}
                        name='outdoors'>
                        <img
                            src={outdoors}
                            className='outdoors'
                    ...
                    <a
                        onClick={(e) => categorySelector("life_hacks")}
                        name='life_hacks'>
                        <img
                            src={lifehacks}
                            className='likehacks'
