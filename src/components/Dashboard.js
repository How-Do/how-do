...
function Dashboard(props) {
  ...
  return (
    <div className="dashboard">
      ...
      <div className="about">
        <p>
          Welcome to howDo – the website where you ask how to do stuff, and we
          tell you how it’s done.
          <br />
          Browse user advice by entering a topic in the search field above. If
          you want to post your own questions, you’ll need to log in. That’s
          just how we do it ‘round here.
          <br />
          Got a better solution? Comment on how you would do it. See if the
          community votes your answer up. Just keep it clean – rudeness and
          crudeness are not how it’s done.
          <br />
